...
export declare const SetupInstanceSchema: z.ZodObject<{
    ...
    url: z.ZodOptional<z.ZodPreprocess<z.ZodString>>;
    db: z.ZodOptional<z.ZodPreprocess<z.ZodString>>;
    username: z.ZodOptional<z.ZodPreprocess<z.ZodString>>;
    api_key: z.ZodOptional<z.ZodPreprocess<z.ZodString>>;
}, z.core.$strip>;
