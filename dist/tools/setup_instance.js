 ...
 */
export async function setupInstance(configStore, credentialStore, input) {
    ...
    if (!finalConfig.url || !finalConfig.db || !finalConfig.username || !finalConfig.api_key) {
        throw new Error(`Incomplete configuration for alias '${alias}'. ` +
...
//# sourceMappingURL=setup_instance.js.map