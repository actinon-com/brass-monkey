...
async function runDiagnostics() {
  ...
  try {
    ...
    const schema = await inspectModel(manager, { instance_alias: alias, model: 'res.partner' });
    console.log(`✅ inspectModel: Retrieved ${Object.keys(schema).length} fields for res.partner`);
